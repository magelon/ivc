...
var _View_AboutPage0 = (function (_super) {
    ...
    _View_AboutPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_23 = this.renderer.createElement(this._el_21, 'h4', null);
        this._text_24 = this.renderer.createText(this._el_23, 'Fire Emblem Heroes IV Check', null);
    ...
    _View_AboutPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import19.Content) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 29)))) {
...
export function viewFactory_AboutPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AboutPage === null)) {
        (renderType_AboutPage = viewUtils.createRenderComponentType('C:/Users/guojin/Desktop/server/ivc/.tmp/pages/about/about.html', 0, import9.ViewEncapsulation.None, styles_AboutPage, {}));
    }
