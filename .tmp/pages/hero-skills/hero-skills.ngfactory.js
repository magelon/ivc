...
var renderType_HeroSkills_Host = null;
var _View_HeroSkills_Host0 = (function (_super) {
    __extends(_View_HeroSkills_Host0, _super);
    function _View_HeroSkills_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_HeroSkills_Host0, renderType_HeroSkills_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_HeroSkills_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-hero-skills', rootSelector, null);
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_HeroSkills0(this.viewUtils, this.injector(0), this._appEl_0);
        ...
        compView_0.create(this._HeroSkills_0_4, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_HeroSkills_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.HeroSkills) && (0 === requestNodeIndex))) {
            return this._HeroSkills_0_4;
        }
        return notFoundResult;
    };
    return _View_HeroSkills_Host0;
}(import1.AppView));
function viewFactory_HeroSkills_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_HeroSkills_Host === null)) {
        (renderType_HeroSkills_Host = viewUtils.createRenderComponentType('', 0, import10.ViewEncapsulation.None, [], {}));
    }
    return new _View_HeroSkills_Host0(viewUtils, parentInjector, declarationEl);
}
export var HeroSkillsNgFactory = new import11.ComponentFactory('page-hero-skills', viewFactory_HeroSkills_Host0, import3.HeroSkills);
var styles_HeroSkills = [];
var renderType_HeroSkills = null;
var _View_HeroSkills0 = (function (_super) {
    __extends(_View_HeroSkills0, _super);
    function _View_HeroSkills0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_HeroSkills0, renderType_HeroSkills, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_HeroSkills0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_11 = this.renderer.createText(null, 'HeroSkills', null);
        ...
        this._Content_15_4 = new import20.Content(this.parentInjector.get(import21.Config), new import22.ElementRef(this._el_15), this.renderer, this.parentInjector.get(import25.App), this.parentInjector.get(import30.Keyboard), this.parentInjector.get(import31.NgZone), this.parentInjector.get(import23.ViewController, null), this.parentInjector.get(import32.Tabs, null));
    ...
    _View_HeroSkills0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import20.Content) && ((15 <= requestNodeIndex) && (requestNodeIndex <= 16)))) {
            return this._Content_15_4;
        }
        return notFoundResult;
    };
    _View_HeroSkills0.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_3 = '';
    ...
    _View_HeroSkills0.prototype.destroyInternal = function () {
        this._Icon_7_3.ngOnDestroy();
        this._Content_15_4.ngOnDestroy();
    };
    _View_HeroSkills0.prototype._handle_click_5_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._MenuToggle_5_5.toggle() !== false);
        return (true && pd_0);
    };
    return _View_HeroSkills0;
}(import1.AppView));
export function viewFactory_HeroSkills0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_HeroSkills === null)) {
        (renderType_HeroSkills = viewUtils.createRenderComponentType('C:/Users/guojin/Desktop/server/ivc/.tmp/pages/hero-skills/hero-skills.html', 0, import10.ViewEncapsulation.None, styles_HeroSkills, {}));
    }
    return new _View_HeroSkills0(viewUtils, parentInjector, declarationEl);
}
//# sourceMappingURL=hero-skills.ngfactory.js.map