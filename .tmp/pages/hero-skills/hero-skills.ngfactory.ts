...
import * as import3 from './hero-skills';
...
var renderType_HeroSkills_Host:import0.RenderComponentType = (null as any);
class _View_HeroSkills_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _HeroSkills_0_4:import3.HeroSkills;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_HeroSkills_Host0,renderType_HeroSkills_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('page-hero-skills',rootSelector,(null as any));
    this._appEl_0 = new import2.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_HeroSkills0(this.viewUtils,this.injector(0),this._appEl_0);
    this._HeroSkills_0_4 = new import3.HeroSkills(this.parentInjector.get(import8.NavController),this.parentInjector.get(import9.NavParams));
    this._appEl_0.initComponent(this._HeroSkills_0_4,[],compView_0);
    compView_0.create(this._HeroSkills_0_4,this.projectableNodes,(null as any));
    this.init([].concat([this._el_0]),[this._el_0],[],[]);
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.HeroSkills) && (0 === requestNodeIndex))) { return this._HeroSkills_0_4; }
    return notFoundResult;
  }
}
function viewFactory_HeroSkills_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_HeroSkills_Host === (null as any))) { (renderType_HeroSkills_Host = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,[],{})); }
  return new _View_HeroSkills_Host0(viewUtils,parentInjector,declarationEl);
}
export const HeroSkillsNgFactory:import11.ComponentFactory<import3.HeroSkills> = new import11.ComponentFactory<import3.HeroSkills>('page-hero-skills',viewFactory_HeroSkills_Host0,import3.HeroSkills);
const styles_HeroSkills:any[] = [];
var renderType_HeroSkills:import0.RenderComponentType = (null as any);
class _View_HeroSkills0 extends import1.AppView<import3.HeroSkills> {
  _text_0:any;
  _el_1:any;
  ...
  /*private*/ _expr_7:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_HeroSkills0,renderType_HeroSkills,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._text_11 = this.renderer.createText((null as any),'HeroSkills',(null as any));
    ...
    this._Content_15_4 = new import20.Content(this.parentInjector.get(import21.Config),new import22.ElementRef(this._el_15),this.renderer,this.parentInjector.get(import25.App),this.parentInjector.get(import30.Keyboard),this.parentInjector.get(import31.NgZone),this.parentInjector.get(import23.ViewController,(null as any)),this.parentInjector.get(import32.Tabs,(null as any)));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import20.Content) && ((15 <= requestNodeIndex) && (requestNodeIndex <= 16)))) { return this._Content_15_4; }
    return notFoundResult;
  }
...
export function viewFactory_HeroSkills0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.HeroSkills> {
  if ((renderType_HeroSkills === (null as any))) { (renderType_HeroSkills = viewUtils.createRenderComponentType('C:/Users/guojin/Desktop/server/ivc/.tmp/pages/hero-skills/hero-skills.html',0,import10.ViewEncapsulation.None,styles_HeroSkills,{})); }
  return new _View_HeroSkills0(viewUtils,parentInjector,declarationEl);
}