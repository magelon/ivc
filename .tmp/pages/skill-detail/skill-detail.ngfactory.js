...
import * as import3 from './skill-detail';
...
var renderType_SkillDetail_Host = null;
var _View_SkillDetail_Host0 = (function (_super) {
    __extends(_View_SkillDetail_Host0, _super);
    function _View_SkillDetail_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_SkillDetail_Host0, renderType_SkillDetail_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_SkillDetail_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-skill-detail', rootSelector, null);
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_SkillDetail0(this.viewUtils, this.injector(0), this._appEl_0);
        this._SkillDetail_0_4 = new import3.SkillDetail(this.parentInjector.get(import8.NavController));
        this._appEl_0.initComponent(this._SkillDetail_0_4, [], compView_0);
        compView_0.create(this._SkillDetail_0_4, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_SkillDetail_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.SkillDetail) && (0 === requestNodeIndex))) {
            return this._SkillDetail_0_4;
        }
        return notFoundResult;
    };
    return _View_SkillDetail_Host0;
}(import1.AppView));
function viewFactory_SkillDetail_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SkillDetail_Host === null)) {
        (renderType_SkillDetail_Host = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, [], {}));
    }
    return new _View_SkillDetail_Host0(viewUtils, parentInjector, declarationEl);
}
export var SkillDetailNgFactory = new import10.ComponentFactory('page-skill-detail', viewFactory_SkillDetail_Host0, import3.SkillDetail);
var styles_SkillDetail = [];
var renderType_SkillDetail = null;
var _View_SkillDetail0 = (function (_super) {
    __extends(_View_SkillDetail0, _super);
    function _View_SkillDetail0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_SkillDetail0, renderType_SkillDetail, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_SkillDetail0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_6 = this.renderer.createText(null, 'SkillDetail', null);
    ...
    _View_SkillDetail0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_SkillDetail0.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    _View_SkillDetail0.prototype.destroyInternal = function () {
        this._Content_10_4.ngOnDestroy();
    };
    return _View_SkillDetail0;
}(import1.AppView));
export function viewFactory_SkillDetail0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SkillDetail === null)) {
        (renderType_SkillDetail = viewUtils.createRenderComponentType('C:/Users/guojin/Desktop/server/ivc/.tmp/pages/skill-detail/skill-detail.html', 0, import9.ViewEncapsulation.None, styles_SkillDetail, {}));
    }
    return new _View_SkillDetail0(viewUtils, parentInjector, declarationEl);
}
//# sourceMappingURL=skill-detail.ngfactory.js.map